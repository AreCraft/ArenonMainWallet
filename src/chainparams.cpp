...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("0",  "185.234.72.130")); //185.114.226.103
        vSeeds.push_back(CDNSSeedData("1",  "81.169.165.47"));
	vSeeds.push_back(CDNSSeedData("2",  "213.202.254.0"));
	vSeeds.push_back(CDNSSeedData("2",  "89.163.140.0"));
